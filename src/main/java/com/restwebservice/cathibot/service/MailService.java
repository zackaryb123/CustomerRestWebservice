...
public class MailService {
    ...
    public void movedFileMail(Customer customer, TaxFile taxFile) throws AddressException, MessagingException, IOException {
        ...
        msg.setSubject("TaxFile "+ taxFile.getFileId()+": has been moved!");
        msg.setContent("CATHiBOT has moved taxFile " + taxFile.getFileId(), "text/html");
